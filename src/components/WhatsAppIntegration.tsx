  ...
  return <section className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Conheça o Moneyfy em menos de 1 minuto!</h2>
          <p className="text-xl text-muted-foreground">Configure e comece a organizar suas finanças!</p>
        </div>
